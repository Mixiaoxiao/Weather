...
//		View.inflate(context, R.layout.label_spinner_layout, this);
		...
		a.recycle();
		FrameLayout.LayoutParams leftViewParams = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT,
...
//		}
		...
		FrameLayout.LayoutParams selectedParams = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT,
				FrameLayout.LayoutParams.WRAP_CONTENT);
